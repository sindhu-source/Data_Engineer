...
if os.path.exists(file_path + file_name):
    try:
        ...
        #Creating a Cursor
        cur = con.cursor()
        print("Databse connetion Successfull")
    ...
    try:
        ...
        for row in csvFile:
            sqlinsert = "INSERT INTO verifiers_dim(uuid,verifier_name) VALUES(%s,%s);"
            cur.execute(sqlinsert,(row['uuid'],row['verifier_name']))
            con.commit()
    ...
    try:
        ...
        cur.execute("select count(*) from verifiers_dim;")
